...
import priority_final as priority
import math
def priorityGui():
    theme("PythonPlus")
    ...
    frame=[
        ...
        [Text("Input Priority ",size=(15,1),font=("Monotype Corsiva",20)),Input(size=(10,1),key="pt",font=("Monotype Corsiva",20))],
    ]
    frame2=[
        [Input(key="pentered")],
    ]
    ...
    layout=[
        ...
        [Text("Algorithm: Priority", size=(30,1), font=("Monotype Corsiva",25))],
